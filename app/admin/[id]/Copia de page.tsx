...
export default function AdminDetail() {
  ...
  // --- Etiquetas originales (MANTENIDAS TODAS) ---
  ...
  // ✅ Función para guardar cambios (FC y Status)
    ...
    <main className="min-h-screen bg-gray-100 p-8 font-sans">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                <Link href="/admin" className="text-blue-600 hover:underline mb-2 inline-block font-medium">← Volver al listado</Link>
        ...
        {/* Content Grid (TODAS LAS CARDS MANTENIDAS) */}
